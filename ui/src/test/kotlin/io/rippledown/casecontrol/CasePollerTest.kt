...
class CasePollerTest {
    ...
    lateinit var handler: CasePollerHandler
    ...
    @Test
    fun `should call handler for updated CasesInfo`() = runTest {
        ...
        every { handler.updateCasesInfo() } returns casesInfo
        ...
        verify(timeout = 2_000) { handler.onUpdate(casesInfo) }
            ...
            with(composeTestRule) {
                setContent {
                    CasePoller(object : Handler by handlerImpl, CasePollerHandler {
                        ...
                        override var casesInfo: (updated: CasesInfo) -> Unit = {}
                    })
                }
