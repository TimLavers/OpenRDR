...
fun ComposeTestRule.assertCreateKbFromSampleMenuItemIsShowing() {
...
fun ComposeTestRule.clickCreateKbFromSampleMenuItem() = onNodeWithContentDescription(CREATE_KB_FROM_SAMPLE_TEXT).performClick()
