...
class RemovingCommentsTest {
    ...
    @Test
    fun `remove comment with condition`() {
        build {
            case("1", "a")
            case("2", "b")
            case("3", "ab")
    ...
    @Test
    fun `remove a comment that is given by several rules`() {
        build {
            (1..4).forEach {
                case(it)
                cornerstoneCase(it)
    ...
    @Test
    fun `cornerstone not presented as conflict if not all instances of comment removed`() {
        build {
            case("1", "a")
            case("2", "b")
            case("3", "ab")
            ...
            session {
                ...
                // comment A from two rules, and one of these is not
