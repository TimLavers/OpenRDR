...
class PersistentRuleTest {
    ...
    fun `secondary constructor`() {
        val pr = PersistentRule(1, 0, "100,101")
        pr.id shouldBe 1
    ...
    @Test
    fun `null id`() {
        val pr = PersistentRule(null, 0, "100,101")
        pr.id shouldBe null
    }
    ...
    fun primaryConstructor() {
        ...
        val pr = PersistentRule(null, 0, conditionIdsSet)
        pr.id shouldBe null
        pr.parentId shouldBe 0
    ...
    fun `constructor from rule`() {
        ...
        val commentAttribute = Attribute(99, "C1", AttributeKind.COMMENT)
        val assignment = AssignValue(commentAttribute, CommentTemplate("Blah"))
        val child = Rule(13, parent, setOf(condition), mutableSetOf(), assignment)
        val childPR = PersistentRule(child)
        childPR.id shouldBe 13
        childPR.parentId shouldBe 12
        childPR.assignment shouldBe assignment
    ...
    fun serialization() {
        ...
        val pr2 = PersistentRule(900, 34, emptySet())
