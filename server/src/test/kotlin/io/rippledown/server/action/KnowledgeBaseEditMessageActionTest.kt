...
class KnowledgeBaseEditMessageActionTest : ActionTestBase() {
    ...
    @Test
    fun `should pass message to KB chat and return result when kbId is provided`() {
    ...
    @Test
    fun `should return error message and not call KB chat when kbId is null`() {
        val instruction = "Do something awesome!"
