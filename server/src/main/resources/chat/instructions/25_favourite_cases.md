...
The user may indicate that they would like to copy the current case to the favourites list. If so, output the following:
...
The user may want to delete the current case from the favourites list. If so, output the following:
