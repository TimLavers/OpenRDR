...
internal class NoConclusionRuleTest : RuleTestBase() {
    ...
    fun stopping_rule_that_applies_to_case_should_not_add_conclusions() {
        val rule = Rule(9, null, null, setOf(cond("a")))
    ...
    fun stopping_rules_are_not_equal_if_conditions_are_different() {
        val rule1 = Rule(9, null, null,setOf(cond("a")))
        val rule2 = Rule(9, null, null,setOf(cond("b")))
        rule1.structurallyEqual(rule2) shouldBe false
    }

    @Test
    fun stopping_rule_has_an_effect_if_it_is_given() {
        val parent = Rule(8, null, Conclusion(1,"A"), setOf(cond("a")))
        val stoppingRule = Rule(9, null, null, setOf(cond("b")))
    ...
    fun stopping_rule_has_no_effect_if_it_is_not_given() {
        ...
        val parent = Rule(7, null, conclusion, setOf(cond("a")))
        val stoppingRule = Rule(9, null, null, setOf(cond("b")))
        parent.addChild(stoppingRule)
        parent.childRules() shouldBe setOf(stoppingRule)
    ...
    fun stopping_rule_can_be_a_sibling() {
        ...
        val parent = Rule(8, null, conclusionA, setOf(cond("a")))
        val childRule = Rule(3, null, conclusionB, setOf(cond("b")))
        val stoppingRule = Rule(78, null, null, setOf(cond("c")))
    ...
    fun test_equals() {
        val conclusionA = Conclusion(1, "A")
        val parent = Rule(7, null, conclusionA, setOf(cond("a")))
    ...
    fun equals_depends_on_conditions() {
        val parent = Rule(8, null, Conclusion(1, "A"), setOf(cond("a")))
        val stopping1 = Rule(9, null, null, setOf(cond("b")))
        val stopping2 = Rule(9, null, null,  setOf(cond("c")))
        stopping1.parent = parent
        stopping2.parent = parent
    ...
    fun equals_depends_on_parent() {
        val parent1 = Rule(11, null, Conclusion(1, "A"), setOf(cond("a")))
        val parent2 = Rule(12, null, Conclusion(2, "B"), setOf(cond("a")))
        val stopping1 = Rule(21, null, null, setOf(cond("b")))
        val stopping2 = Rule(22, null, null,setOf(cond("b")))
