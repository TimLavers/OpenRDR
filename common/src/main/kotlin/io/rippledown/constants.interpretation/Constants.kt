...
const val COMMENT_TO_BE_REPLACED = "Select the comment to be replaced"
const val COMMENT_TO_BE_THE_REPLACEMENT = "Select or create a comment to be the replacement"
