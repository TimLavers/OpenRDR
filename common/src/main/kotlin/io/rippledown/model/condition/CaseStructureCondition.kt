...
data class CaseStructureCondition(override val id: Int? = null,
                                  val predicate: CaseStructurePredicate): Condition() {
    ...
    override fun alignAttributes(idToAttribute: (Int) -> Attribute) = CaseStructureCondition(id, predicate.alignAttributes(idToAttribute))
...
object CaseStructureConditionSerializer: KSerializer<CaseStructureCondition> {
    ...
    override fun deserialize(decoder: Decoder): CaseStructureCondition {
        ...
        return CaseStructureCondition(id, predicate)
    }
