...
@Serializable
data class EditableGTECondition(val attribute: Attribute, val initialCutoff: EditableValue): EditableCondition {
    ...
    override fun condition(value: String): Condition {
        ...
        return EpisodicCondition(attribute, GreaterThanOrEquals(cutoff), Current)
    }
}